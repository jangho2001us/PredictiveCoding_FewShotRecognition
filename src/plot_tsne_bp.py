...
def main():
    ...
    # get model
    root_save = "/home/jangho/data2/exp_etri_few"

    # 1-shot 20-way
    name = "220510_BP_nsTr1_nqTr5_cVa20_nsVa1_nqVa15_ep100_lr0.001_seed2"

    ckptpath = os.path.join(root_save, name, 'best_model.pth')
